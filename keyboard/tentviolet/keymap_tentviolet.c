...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KEYMAP(ESC,  1,   2,   3,   4,   5,   6,   7,   8,   9,   0,   MINS,BSPC, \
           ...
           LSFT, Z,   X,   C,   V,   B,   N,   M,   COMM,DOT, SLSH,RBRC,RSFT, \
           LCTL, LGUI,LALT,          SPC,           RALT,FN0 ,RCTL,EQL, END),
    ...
    KEYMAP(GRV,  F1,  F2,  F3,  F4,  F5,  F6,  F7,  F8,  F9,  F10, PSCR,INS,  \
           ...
           CAPS, TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,UP,  TRNS,VOLU,PGUP, \
           TRNS, TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,LEFT,DOWN,RGHT,TRNS,PGDN, \
           TRNS, TRNS,TRNS,          FN1,           TRNS,TRNS,TRNS,DEL, END),

    /* 2: fn layer 2 - multimedia */
    KEYMAP( PWR, SLEP,WAKE,MNXT,MPRV,MSTP,MPLY,MSEL,TRNS,TRNS,TRNS,TRNS,TRNS, \
           WSCH, WHOM,WBAK,WFWD,WSTP,WREF,WFAV,WH_L,WH_D,WH_U,WH_R,TRNS,TRNS, \
           MYCM, TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,MS_L,MS_D,MS_U,MS_R,TRNS,ACL0, \
           TRNS, TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,BTN1,BTN2,BTN3,BTN4,TRNS,MS_U, \
           TRNS, TRNS,TRNS,          TRNS,          TRNS,TRNS,TRNS,MS_L,MS_D),
